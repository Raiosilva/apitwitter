module Api
  module V1
    class UsersController < Api::V1::ApiController
      ...
      before_action :set_user, only: %i[show update destroy following followers]
      load_and_authorize_resource except: %i[followers following create]

      before_action :set_page, only: %i[show following followers]
      ...
      def followers
        @followers = @user.following_by_type('User').paginate(page: @page)
